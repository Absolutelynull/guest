...
?>
    ...
    <div id="ubb">
        <img src="image/fontsize.gif" title="字体大小" alt="字体大小" />
        <img src="image/space.gif" title="线条" alt="线条" />
        <img src="image/bold.gif" title="粗体" />
        <img src="image/italic.gif" title="斜体" />
        <img src="image/underline.gif" title="下划线" />
        <img src="image/strikethrough.gif" title="删除线" />
        <img src="image/space.gif" />
        <img src="image/color.gif" title="颜色" />
        <img src="image/url.gif" title="超链接" />
        <img src="image/email.gif" title="邮件" />
        <img src="image/image.gif" title="图片" />
        <img src="image/swf.gif" title="flash" />
        <img src="image/movie.gif" title="影片" />
        <img src="image/space.gif" />
        <img src="image/left.gif" title="左区域" />
        <img src="image/center.gif" title="中区域" />
        <img src="image/right.gif" title="右区域" />
        <img src="image/space.gif" />
        <img src="image/increase.gif" title="扩大输入区" />
        <img src="image/decrease.gif" title="缩小输入区" />
